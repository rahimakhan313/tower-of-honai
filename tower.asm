.data
Author:
    .asciiz     "\t\tWelcome To The Efficient Guidline OF Towers of Hanoi\n"  
input:  
    .asciiz    "\nEnter the number of disks: "
Move:
    .asciiz     "\nMove disk from "
Error:
    .asciiz       "\nNumber of disk must be greater than 0"
To:
    .ascii      " to "
    .globl main
    .text         
main:
    ...
    addi $a1, $zero, 1		#$a1 = starting pole
    addi $a2, $zero, 3		#$a2 = ending pole
    addi $a3, $zero, 2		#$a3 = auxiliary pole
